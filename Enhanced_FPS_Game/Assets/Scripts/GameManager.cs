...
public class GameManager : MonoBehaviour {
	...
	public static GameManager gm; // THIS IS CALLED A SINGLETON, ONLY ONE OF THESE CREATED.
	...
	public TMP_Text scoreOutlineText;
	...
	// Allows to play the same level again.
	...
	public void SetScoreOutline()
	{
		scoreOutlineText.text = "Your Score: " + score + "\n" + "\n" +

								"Score To Win: " + beatLevelScore;
	}
